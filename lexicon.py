LEXICON_EN: dict[str, str] = {
    '/start': 'Hello! This bot can analyze your personality type in two formats:\n\n'\
    ...
    '/help': 'For taking the psychological test you need to send command \\test\n'\
        'For completing analysis through free text form you need to send command \\text',
    '/test': 'In order to complete test you will need to answer 70 questions. The test will take about 15 minutes\n' \
