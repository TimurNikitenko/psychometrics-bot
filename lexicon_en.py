START_MESSAGE = 'Hello! This bot can analyze your personality type in two formats:\n\n'\
        '1. Official psychological test - you will need to answer N questions to get result\n'\
...
HELP_MESSAGE = 'For taking the psychological test you need to send command \\test\n'\
        'For completing analysis through free text form you need to send command \\text'

TEST_MESSAGE = 'In order to complete test you will need to answer 70 questions. The test will take about 15 minutes\n' \
